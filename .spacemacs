...
you should place your code here."
  ...
  (add-hook 'text-mode-hook 'dotspacemacs/enable-autofill)
  ;;(add-hook 'prog-mode-hook 'dotspacemacs/enable-autofill)
  ;;(add-hook 'c-mode-hook 'dotspacemacs/enable-autofill)
